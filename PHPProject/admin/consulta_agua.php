...
<body>
	...
	<section class = "section">
		...
		$sql = "SELECT * FROM rega ORDER BY hinicial DESC
		...
		<?php
			...
			<tr align="center" >
			<td><?php echo $user['idrega']; ?></td>
			<td>
				<?php
					if ($user['estado'] == 'S' && $user['tiporega'] == 'M')
					{
						echo 'Ligado manualmente';
					}
					else if ($user['estado'] == 'S' && $user['tiporega'] == 'A')
					{
						echo 'Ligado automaticamente';
					}
					else if ($user['estado'] == 'N' && $user['tiporega'] == 'A')
					{
						echo 'Desligado automaticamente';
					}
					else
						echo 'Desligado manualmente';
			
			
			
				?>
			</td>
			<td><?php echo $user['hinicial']; ?></td>
		...
		<?php
			...
			$sql_todos_registos = mysql_query("SELECT * FROM rega ORDER BY hinicial DESC");
